                  ...
                  BlocBuilder<cubit.SubmitNcpCubit, cubit.SubmitNcpState>(
                    builder: (context, state) {
                      return UIDropdown.basic(
                          ...
                          onChange: (value) {
                            context.read<cubit.SubmitNcpCubit>().selectVehicle(
                                  value ?? '',
                                );
                          });
                    },
                                ...
                                onTap: (state.isAbletoSearch == true)
                                    ? () {
                                        ...
                                        context
                                            ...
                                            .add(SearchNcpNumber(
                                                params: NcpPartNumberParameter(
                                              idVehicle: data.selectedVehicle,
                                              packingMonth: data.selectedMonth,
                                      ...
                                      if (state.dataValue == null) {
                                        ...
                                        context
                                            ...
                                            .setSelectedElemet(
                                              commissionForm:
                                                  data?.commissionFrom,
                                              commissionTo: data?.commissionTo,
                                              productionNoForm:
                                              ...
                                              paintColor: data?.interiorColour,
                                              location: data?.locationAreaName,
