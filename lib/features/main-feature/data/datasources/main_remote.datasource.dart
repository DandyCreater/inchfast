...
abstract class MainRemoteDataSource {
  ...
  Future<PackingMonthModel?> packingMonth();
  Future<VehicleModel?> vehicleData(String params);
  Future<NcpNumberModel?> getNcpNumber();
  Future<NcpPartNumberModel?> searchNcpPartNumber(
    NcpPartNumberParameter params,
  );
  Future<SubmitNcpModel?> submitNcpData(
    AddNcpParameter params,
  );
  Future<NcpPartTypeModel?> ncpPartData();
  Future<NcpFeedBackLocationModel?> ncpFeedBackLocation();
  Future<ShortageProblemModel?> ncpShortageProblem();
  Future<CloseUnloadingModel?> closeUnloading(String params);
}
